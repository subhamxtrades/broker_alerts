...
#define OSPF_HELLO_INTERVAL         3
#define OSPF_DEAD_INTERVAL          12
...
int ospf_handle_hello_packet(struct ethernet_hdr *eth_hdr, struct ospf_header *ospf_hdr, struct ospf_hello *hello,
                             uint8_t pid, ospf_session_t *session, uint32_t src_ip);
int ospf_handle_dd_packet(struct ethernet_hdr *eth_hdr, struct ospf_header *ospf_hdr, struct ospf_dd *dd,
                          uint8_t pid, ospf_session_t *session, uint32_t src_ip);
int ospf_handle_lsr_packet(struct ethernet_hdr *eth_hdr, struct ospf_header *ospf_hdr, struct ospf_lsr *lsr,
                           uint8_t pid, ospf_session_t *session, uint32_t src_ip);
int ospf_handle_lsu_packet(struct ethernet_hdr *eth_hdr, struct ospf_header *ospf_hdr, struct ospf_lsu *lsu,
                           uint8_t pid, ospf_session_t *session, uint32_t src_ip);
int ospf_handle_lsack_packet(struct ethernet_hdr *eth_hdr, struct ospf_header *ospf_hdr,
                           uint8_t pid, ospf_session_t *session, uint32_t src_ip);
